...
observe({
  ...
  ##{ ## use loaded data
    ...
    updateSelectInput(session, inputId="by_group2", choices = metricCols2(), selected= metricCols2()[1])
    ...
    updateSelectInput(session, inputId="px", choices = metricCols1(), selected= metricCols1()[1])
    updateSelectInput(session, inputId="py", choices = metricCols1(), selected= metricCols1()[2])
  ...
  # 
  # }
  updateSelectInput(session, inputId="ConditioningVariables", choices = metricCols1(), selected= NULL)
  updateSelectInput(session, inputId="ConditioningVariables2", choices = metricCols2(), selected= NULL)
  updateSelectInput(session, inputId="ConditioningVariablesR", choices = metricCols1(), selected= NULL)
  updateSelectInput(session, inputId="ConditioningVariables2R", choices = metricCols2(), selected= NULL)
...
mydataR2show <- reactive({
  ...
  ##print(input$ConditioningVariablesR)
  ##print(input$ConditioningVariables2R)
...
## stuffs for graph : trending. ## filter on filters
...
selectMetrics  <- reactive({
  ...
  if(length(input$ConditioningVariables2)){
    print('lllllll')
    print(input$ConditioningVariables2)
